    ...
    >
      ...
      <ul className="flex items-center gap-2 flex-wrap">
        {skills?.map((skill) => (
          <li
            key={skill}
            className="flex justify-center items-center h-6 px-2 text-white dark:text-ternary dark:font-semibold bg-brand border border-brand rounded-full shadow-md"
          >
